# =============================================================================
# Error Observability Tools Container Launcher (PowerShell)
...
$ContainerName = "error-observability-tools-shell"
...
Write-Host " Error Observability Tools" -ForegroundColor Green
Write-Host "===========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Available scripts:"
Write-Host "  ./scripts/generate-secrets.sh   - Generate .env with secure secrets" -ForegroundColor Yellow
Write-Host ""
